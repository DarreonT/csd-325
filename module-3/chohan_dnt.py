# Modified for M3.2 Assignment
# - Changed input prompt to 'dt: '
# - House fee changed to 12%
# - Added 10 mon bonus if dice total is 2 or 7
# - Bonus message printed when bonus is applied
...
while True:  # Main game loop.
    ...
    if total == 2 or total == 7:
        print('You rolled a', total, '- you get a 10 mon bonus!')
        purse += 10
